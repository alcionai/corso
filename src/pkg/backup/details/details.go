...
func (i OneDriveInfo) Values() []string {
	return []string{i.ItemName, i.ParentPath, strconv.FormatInt(i.Size, 10), common.FormatTabularDisplayTime(i.Created), common.FormatTabularDisplayTime(i.LastModified)}
}
