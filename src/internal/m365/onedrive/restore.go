...
func RestoreCollection(
	...
	ctx, end := diagnostics.Span(ctx, "m365:drive:restoreCollection", diagnostics.Label("path", directory))
	defer end()
	...
	trace.Log(ctx, "m365:oneDrive:restoreCollection", directory.String())
...
func restoreData(
	...
	ctx, end := diagnostics.Span(ctx, "m365:oneDrive:restoreItem", diagnostics.Label("item_uuid", itemData.UUID()))
	defer end()

	trace.Log(ctx, "m365:oneDrive:restoreItem", itemData.UUID())
