...
func TestItemCollectorUnitSuite(t *testing.T) {
...
type ItemCollectorIntgSuite struct {
	tester.Suite
	userID string
...
func TestItemCollectorIntgSuite(t *testing.T) {
	suite.Run(t, &ItemCollectorIntgSuite{
...
func (suite *ItemCollectorIntgSuite) SetupSuite() {
	t := suite.T()
...
func (suite *ItemCollectorIntgSuite) TestCreateGetDeleteFolder() {
	t := suite.T()
...
func (suite *ItemCollectorIntgSuite) TestOneDriveNewCollections() {
