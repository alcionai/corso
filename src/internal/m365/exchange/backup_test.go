...
type CollectionsIntegrationSuite struct {
	tester.Suite
	user     string
	site     string
	tenantID string
...
func TestCollectionsIntegrationSuite(t *testing.T) {
	suite.Run(t, &CollectionsIntegrationSuite{
...
func (suite *CollectionsIntegrationSuite) SetupSuite() {
...
func (suite *CollectionsIntegrationSuite) TestMailFetch() {
	var (
...
func (suite *CollectionsIntegrationSuite) TestDelta() {
	var (
		userID   = tester.M365UserID(suite.T())
		users    = []string{userID}
		handlers = BackupHandlers(suite.ac)
...
// M365 mail objects
func (suite *CollectionsIntegrationSuite) TestMailSerializationRegression() {
	t := suite.T()
...
func (suite *CollectionsIntegrationSuite) TestContactSerializationRegression() {
	var (
		users    = []string{suite.user}
		handlers = BackupHandlers(suite.ac)
	)
...
func (suite *CollectionsIntegrationSuite) TestEventsSerializationRegression() {
	t := suite.T()
...
func (suite *BackupUnitSuite) TestFilterContainersAndFillCollections() {
	var (
...
func (suite *BackupUnitSuite) TestFilterContainersAndFillCollections_DuplicateFolders() {
...
func (suite *BackupUnitSuite) TestFilterContainersAndFillCollections_repeatedItems() {
	newDelta := api.DeltaUpdate{URL: "delta_url"}
...
func (suite *BackupUnitSuite) TestFilterContainersAndFillCollections_incrementals_nondelta() {
	var (
		userID   = "user_id"
		tenantID = suite.creds.AzureTenantID
