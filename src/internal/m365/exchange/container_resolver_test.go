...
type ContainerCacheUnitSuite struct {
	tester.Suite
}

func TestContainerCacheUnitSuite(t *testing.T) {
	suite.Run(t, &ContainerCacheUnitSuite{Suite: tester.NewUnitSuite(t)})
}
...
func (suite *ContainerCacheUnitSuite) TestCheckIDAndName() {
...
func (suite *ContainerCacheUnitSuite) TestCheckRequiredValues() {
...
func (suite *ContainerCacheUnitSuite) TestAddFolder() {
	table := []struct {
		name  string
...
type ConfiguredContainerCacheUnitSuite struct {
	tester.Suite
...
func (suite *ConfiguredContainerCacheUnitSuite) SetupTest() {
	suite.fc, suite.allContainers = resolverWithContainers(4, false)
}

func TestConfiguredContainerCacheUnitSuite(t *testing.T) {
	suite.Run(t, &ConfiguredContainerCacheUnitSuite{Suite: tester.NewUnitSuite(t)})
}

func (suite *ConfiguredContainerCacheUnitSuite) TestRefreshContainer_RefreshParent() {
	t := suite.T()
...
func (suite *ConfiguredContainerCacheUnitSuite) TestRefreshContainer_RefreshParent_NotFoundDeletes() {
	t := suite.T()
...
func (suite *ConfiguredContainerCacheUnitSuite) TestRefreshContainer_RefreshAncestor_NotFoundDeletes() {
	t := suite.T()
...
func (suite *ConfiguredContainerCacheUnitSuite) TestRefreshContainer_RefreshAncestor_NewParent() {
	t := suite.T()
...
func (suite *ConfiguredContainerCacheUnitSuite) TestRefreshContainer_RefreshFolder_FolderDeleted() {
	t := suite.T()
...
func (suite *ConfiguredContainerCacheUnitSuite) TestDepthLimit() {
	table := []struct {
		name          string
		numContainers int
		check         assert.ErrorAssertionFunc
...
func (suite *ConfiguredContainerCacheUnitSuite) TestPopulatePaths() {
	t := suite.T()
...
func (suite *ConfiguredContainerCacheUnitSuite) TestLookupCachedFolderNoPathsCached() {
	t := suite.T()
...
func (suite *ConfiguredContainerCacheUnitSuite) TestLookupCachedFolderCachesPaths() {
	t := suite.T()
...
func (suite *ConfiguredContainerCacheUnitSuite) TestLookupCachedFolderErrorsParentNotFound() {
	t := suite.T()
...
func (suite *ConfiguredContainerCacheUnitSuite) TestLookupCachedFolder_Errors_PathsNotBuilt() {
	t := suite.T()
...
func (suite *ConfiguredContainerCacheUnitSuite) TestLookupCachedFolderErrorsNotFound() {
	t := suite.T()
...
func (suite *ConfiguredContainerCacheUnitSuite) TestAddToCache() {
	t := suite.T()
