...
type BackupLibrariesUnitSuite struct {
	tester.Suite
}

func TestBackupLibrariesUnitSuite(t *testing.T) {
	suite.Run(t, &BackupLibrariesUnitSuite{Suite: tester.NewUnitSuite(t)})
}

func (suite *BackupLibrariesUnitSuite) TestUpdateCollections() {
