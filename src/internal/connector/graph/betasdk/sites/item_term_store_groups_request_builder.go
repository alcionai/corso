...
// ItemTermStoreGroupsRequestBuilderGetQueryParameters get the list of group objects of a store
...
// NewItemTermStoreGroupsRequestBuilderInternal instantiates a new GroupsRequestBuilder and sets the default values.
...
// NewItemTermStoreGroupsRequestBuilder instantiates a new GroupsRequestBuilder and sets the default values.
...
func (m *ItemTermStoreGroupsRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemTermStoreGroupsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemTermStoreGroupsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTermStoreGroupsRequestBuilderGetRequestConfiguration)(i9f80f9c244f49392da487c12fb13b03692a695949f8ff3e2d6cdb7662a064016.GroupCollectionResponseable, error) {
    ...
    res, err := m.requestAdapter.SendAsync(ctx, requestInfo, i9f80f9c244f49392da487c12fb13b03692a695949f8ff3e2d6cdb7662a064016.CreateGroupCollectionResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i9f80f9c244f49392da487c12fb13b03692a695949f8ff3e2d6cdb7662a064016.GroupCollectionResponseable), nil
}
