...
type Windows81GeneralConfigurationable interface {
    ...
    GetMinimumAutoInstallClassification()(*UpdateClassification)
    ...
    GetUpdatesMinimumAutoInstallClassification()(*UpdateClassification)
    ...
    SetMinimumAutoInstallClassification(value *UpdateClassification)()
    ...
    SetUpdatesMinimumAutoInstallClassification(value *UpdateClassification)()
