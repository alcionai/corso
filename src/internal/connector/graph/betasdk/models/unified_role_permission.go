...
// GetExcludedResourceActions gets the excludedResourceActions property value. The excludedResourceActions property
...
// SetExcludedResourceActions sets the excludedResourceActions property value. The excludedResourceActions property
