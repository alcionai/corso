...
// SetRoleScopeTagIds sets the roleScopeTagIds property value. List of Scope Tags for this App configuration entity.
func (m *ManagedDeviceMobileAppConfiguration) SetRoleScopeTagIds(value []string)() {
