...
// GetCalendarGroupId gets the calendarGroupId property value. The calendarGroup in which to create the calendar. If the user has never explicitly set a group for the calendar, this property is  null.
func (m *Calendar) GetCalendarGroupId()(*string) {
    return m.calendarGroupId
}
...
func (m *Calendar) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["calendarGroupId"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetStringValue()
        if err != nil {
            return err
        }
        if val != nil {
            m.SetCalendarGroupId(val)
        }
        return nil
    }
    ...
    res["isSharedWithMe"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetBoolValue()
        if err != nil {
            return err
        }
        if val != nil {
            m.SetIsSharedWithMe(val)
        }
        return nil
    }
...
func (m *Calendar) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    {
        err = writer.WriteStringValue("calendarGroupId", m.GetCalendarGroupId())
        if err != nil {
            return err
        }
    }
    ...
    {
        err = writer.WriteBoolValue("isSharedWithMe", m.GetIsSharedWithMe())
        if err != nil {
            return err
        }
    }
...
// SetCalendarGroupId sets the calendarGroupId property value. The calendarGroup in which to create the calendar. If the user has never explicitly set a group for the calendar, this property is  null.
func (m *Calendar) SetCalendarGroupId(value *string)() {
    m.calendarGroupId = value
}
