...
func (m *DriveItem) GetActivities()([]ItemActivityOLDable) {
    return m.activities
}
...
func (m *DriveItem) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["media"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateMediaFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetMedia(val.(Mediaable))
        }
        return nil
    }
    ...
    res["source"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetSource(val.(DriveItemSourceable))
        }
        return nil
    }
...
// GetMedia gets the media property value. Information about the media (audio or video) item. Read-write. Only on OneDrive for Business and SharePoint.
func (m *DriveItem) GetMedia()(Mediaable) {
    return m.media
}
...
// GetSource gets the source property value. Information about the drive item source. Read-only. Only on OneDrive for Business and SharePoint.
func (m *DriveItem) GetSource()(DriveItemSourceable) {
    return m.source
}
...
func (m *DriveItem) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    {
        err = writer.WriteObjectValue("media", m.GetMedia())
        if err != nil {
            return err
        }
    }
...
// SetMedia sets the media property value. Information about the media (audio or video) item. Read-write. Only on OneDrive for Business and SharePoint.
func (m *DriveItem) SetMedia(value Mediaable)() {
    m.media = value
}
...
// SetSource sets the source property value. Information about the drive item source. Read-only. Only on OneDrive for Business and SharePoint.
func (m *DriveItem) SetSource(value DriveItemSourceable)() {
    m.source = value
}
