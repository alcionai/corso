...
// GetExcludeTarget gets the excludeTarget property value. A single entity that's excluded from using this feature.
...
// GetIncludeTarget gets the includeTarget property value. A single entity that's allowed to use this feature.
...
// SetExcludeTarget sets the excludeTarget property value. A single entity that's excluded from using this feature.
func (m *AuthenticationMethodFeatureConfiguration) SetExcludeTarget(value FeatureTargetable)() {
    m.excludeTarget = value
}
// SetIncludeTarget sets the includeTarget property value. A single entity that's allowed to use this feature.
