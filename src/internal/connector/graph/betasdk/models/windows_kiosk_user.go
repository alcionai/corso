...
// NewWindowsKioskUser instantiates a new windowsKioskUser and sets the default values.
...
func (m *WindowsKioskUser) GetOdataType()(*string) {
    return m.odataType
}
...
func (m *WindowsKioskUser) SetOdataType(value *string)() {
    m.odataType = value
}
