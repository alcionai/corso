...
type BookingBusiness struct {
    ...
    staffMembers []BookingStaffMemberable
...
func (m *BookingBusiness) GetCustomers()([]BookingCustomerable) {
    return m.customers
}
...
func (m *BookingBusiness) GetStaffMembers()([]BookingStaffMemberable) {
...
func (m *BookingBusiness) SetCustomers(value []BookingCustomerable)() {
    m.customers = value
}
...
func (m *BookingBusiness) SetStaffMembers(value []BookingStaffMemberable)() {
