...
// EducationUser provides operations to manage the sites property of the microsoft.graph.browserSiteList entity.
...
// GetShowInAddressList gets the showInAddressList property value. The showInAddressList property
...
// SetShowInAddressList sets the showInAddressList property value. The showInAddressList property
