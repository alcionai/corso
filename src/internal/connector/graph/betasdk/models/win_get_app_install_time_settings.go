...
// NewWinGetAppInstallTimeSettings instantiates a new winGetAppInstallTimeSettings and sets the default values.
...
func CreateWinGetAppInstallTimeSettingsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
...
func (m *WinGetAppInstallTimeSettings) GetDeadlineDateTime()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.deadlineDateTime
}
// GetFieldDeserializers the deserialization information for the current model
func (m *WinGetAppInstallTimeSettings) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *WinGetAppInstallTimeSettings) GetOdataType()(*string) {
    return m.odataType
}
// GetUseLocalTime gets the useLocalTime property value. Whether the local device time or UTC time should be used when determining the deadline times.
func (m *WinGetAppInstallTimeSettings) GetUseLocalTime()(*bool) {
    return m.useLocalTime
}
// Serialize serializes information the current object
func (m *WinGetAppInstallTimeSettings) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *WinGetAppInstallTimeSettings) SetDeadlineDateTime(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.deadlineDateTime = value
}
// SetOdataType sets the @odata.type property value. The OdataType property
func (m *WinGetAppInstallTimeSettings) SetOdataType(value *string)() {
    m.odataType = value
}
// SetUseLocalTime sets the useLocalTime property value. Whether the local device time or UTC time should be used when determining the deadline times.
func (m *WinGetAppInstallTimeSettings) SetUseLocalTime(value *bool)() {
