...
func (m *DeviceEnrollmentWindowsHelloForBusinessConfiguration) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["securityKeyForSignIn"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseEnablement)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetSecurityKeyForSignIn(val.(*Enablement))
        }
        return nil
    }
...
// GetSecurityKeyForSignIn gets the securityKeyForSignIn property value. Possible values of a property
func (m *DeviceEnrollmentWindowsHelloForBusinessConfiguration) GetSecurityKeyForSignIn()(*Enablement) {
    return m.securityKeyForSignIn
}
...
func (m *DeviceEnrollmentWindowsHelloForBusinessConfiguration) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    if m.GetSecurityKeyForSignIn() != nil {
        cast := (*m.GetSecurityKeyForSignIn()).String()
        err = writer.WriteStringValue("securityKeyForSignIn", &cast)
        if err != nil {
            return err
        }
    }
...
// SetSecurityKeyForSignIn sets the securityKeyForSignIn property value. Possible values of a property
func (m *DeviceEnrollmentWindowsHelloForBusinessConfiguration) SetSecurityKeyForSignIn(value *Enablement)() {
    m.securityKeyForSignIn = value
}
