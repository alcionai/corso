...
func (m *PrinterLocation) GetFloorNumber()(*int32) {
...
// GetRoomNumber gets the roomNumber property value. The roomNumber property
func (m *PrinterLocation) GetRoomNumber()(*int32) {
    return m.roomNumber
}
...
func (m *PrinterLocation) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    {
        err := writer.WriteInt32Value("roomNumber", m.GetRoomNumber())
        if err != nil {
            return err
        }
    }
...
func (m *PrinterLocation) SetFloorNumber(value *int32)() {
    m.floorNumber = value
}
...
// SetRoomNumber sets the roomNumber property value. The roomNumber property
func (m *PrinterLocation) SetRoomNumber(value *int32)() {
    m.roomNumber = value
}
