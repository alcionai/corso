...
// IosUpdateDeviceStatus provides operations to manage the sites property of the microsoft.graph.browserSiteList entity.
...
func (m *IosUpdateDeviceStatus) GetPlatform()(*int32) {
    return m.platform
}
...
func (m *IosUpdateDeviceStatus) SetPlatform(value *int32)() {
    m.platform = value
}
