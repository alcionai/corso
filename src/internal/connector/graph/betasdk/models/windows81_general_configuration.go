...
func (m *Windows81GeneralConfiguration) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["minimumAutoInstallClassification"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseUpdateClassification)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetMinimumAutoInstallClassification(val.(*UpdateClassification))
        }
        return nil
    }
    ...
    res["updatesMinimumAutoInstallClassification"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseUpdateClassification)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetUpdatesMinimumAutoInstallClassification(val.(*UpdateClassification))
        }
        return nil
    }
...
func (m *Windows81GeneralConfiguration) GetMinimumAutoInstallClassification()(*UpdateClassification) {
    return m.minimumAutoInstallClassification
}
...
func (m *Windows81GeneralConfiguration) GetUpdatesMinimumAutoInstallClassification()(*UpdateClassification) {
    return m.updatesMinimumAutoInstallClassification
}
...
func (m *Windows81GeneralConfiguration) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    if m.GetMinimumAutoInstallClassification() != nil {
        cast := (*m.GetMinimumAutoInstallClassification()).String()
        err = writer.WriteStringValue("minimumAutoInstallClassification", &cast)
        if err != nil {
            return err
        }
    }
    ...
    if m.GetUpdatesMinimumAutoInstallClassification() != nil {
        cast := (*m.GetUpdatesMinimumAutoInstallClassification()).String()
        err = writer.WriteStringValue("updatesMinimumAutoInstallClassification", &cast)
        if err != nil {
            return err
        }
    }
