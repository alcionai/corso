...
func (m *DeviceEnrollmentPlatformRestriction) GetBlockedManufacturers()([]string) {
    return m.blockedManufacturers
}
// GetBlockedSkus gets the blockedSkus property value. Collection of blocked Skus.
func (m *DeviceEnrollmentPlatformRestriction) GetBlockedSkus()([]string) {
    return m.blockedSkus
}
...
func (m *DeviceEnrollmentPlatformRestriction) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["blockedManufacturers"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            ...
            m.SetBlockedManufacturers(res)
        }
        return nil
    }
    res["blockedSkus"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfPrimitiveValues("string")
        if err != nil {
            return err
        }
...
func (m *DeviceEnrollmentPlatformRestriction) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetBlockedManufacturers() != nil {
        err := writer.WriteCollectionOfStringValues("blockedManufacturers", m.GetBlockedManufacturers())
        if err != nil {
            return err
        }
    }
...
func (m *DeviceEnrollmentPlatformRestriction) SetBlockedManufacturers(value []string)() {
    m.blockedManufacturers = value
}
// SetBlockedSkus sets the blockedSkus property value. Collection of blocked Skus.
