...
// PrinterBase provides operations to manage the sites property of the microsoft.graph.browserSiteList entity.
...
// SetIsAcceptingJobs sets the isAcceptingJobs property value. The isAcceptingJobs property
