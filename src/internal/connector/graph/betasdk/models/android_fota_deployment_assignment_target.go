...
func (m *AndroidFotaDeploymentAssignmentTarget) GetAdditionalData()(map[string]interface{}) {
...
func (m *AndroidFotaDeploymentAssignmentTarget) SetAdditionalData(value map[string]interface{})() {
