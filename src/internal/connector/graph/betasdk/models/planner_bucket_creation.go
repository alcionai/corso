...
// NewPlannerBucketCreation instantiates a new plannerBucketCreation and sets the default values.
...
func CreatePlannerBucketCreationFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    if parseNode != nil {
        ...
        if mappingValueNode != nil {
            ...
            if mappingValue != nil {
                switch *mappingValue {
                    case "#microsoft.graph.plannerExternalBucketSource":
...
func (m *PlannerBucketCreation) GetOdataType()(*string) {
    return m.odataType
}
// Serialize serializes information the current object
func (m *PlannerBucketCreation) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *PlannerBucketCreation) SetOdataType(value *string)() {
    m.odataType = value
}
