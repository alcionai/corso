...
func (m *ItemOnenoteSectionGroupsItemSectionsItemCopyToNotebookPostRequestBody) GetBackingStore()(BackingStore) {
...
func (m *ItemOnenoteSectionGroupsItemSectionsItemCopyToNotebookPostRequestBody) SetBackingStore(value BackingStore)() {
