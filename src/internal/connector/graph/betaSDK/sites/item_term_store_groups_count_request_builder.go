...
// NewItemTermStoreGroupsCountRequestBuilderInternal instantiates a new CountRequestBuilder and sets the default values.
func NewItemTermStoreGroupsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTermStoreGroupsCountRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/sites/{site%2Did}/termStore/groups/$count{?%24search,%24filter}";
...
// NewItemTermStoreGroupsCountRequestBuilder instantiates a new CountRequestBuilder and sets the default values.
...
func (m *ItemTermStoreGroupsCountRequestBuilder) CreateGetRequestInformation(ctx context.Context, requestConfiguration *ItemTermStoreGroupsCountRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
