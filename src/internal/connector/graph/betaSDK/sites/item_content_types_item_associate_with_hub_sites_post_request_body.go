...
func (m *ItemContentTypesItemAssociateWithHubSitesPostRequestBody) GetBackingStore()(BackingStore) {
...
func (m *ItemContentTypesItemAssociateWithHubSitesPostRequestBody) SetBackingStore(value BackingStore)() {
