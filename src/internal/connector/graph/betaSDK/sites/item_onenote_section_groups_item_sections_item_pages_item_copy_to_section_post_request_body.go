...
// ItemOnenoteSectionGroupsItemSectionsItemPagesItemCopyToSectionPostRequestBody provides operations to call the copyToSection method.
...
func (m *ItemOnenoteSectionGroupsItemSectionsItemPagesItemCopyToSectionPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemOnenoteSectionGroupsItemSectionsItemPagesItemCopyToSectionPostRequestBody) GetBackingStore()(BackingStore) {
...
func (m *ItemOnenoteSectionGroupsItemSectionsItemPagesItemCopyToSectionPostRequestBody) SetAdditionalData(value map[string]interface{})() {
    m.GetBackingStore().Set("additionalData", value)
}
// SetBackingStore sets the backingStore property value. Stores model information.
func (m *ItemOnenoteSectionGroupsItemSectionsItemPagesItemCopyToSectionPostRequestBody) SetBackingStore(value BackingStore)() {
