...
// ItemOnenoteNotebooksItemSectionsItemCopyToNotebookPostRequestBody provides operations to call the copyToNotebook method.
...
func (m *ItemOnenoteNotebooksItemSectionsItemCopyToNotebookPostRequestBody) GetAdditionalData()(map[string]interface{}) {
...
func (m *ItemOnenoteNotebooksItemSectionsItemCopyToNotebookPostRequestBody) GetBackingStore()(BackingStore) {
...
func (m *ItemOnenoteNotebooksItemSectionsItemCopyToNotebookPostRequestBody) SetAdditionalData(value map[string]interface{})() {
    m.GetBackingStore().Set("additionalData", value)
}
// SetBackingStore sets the backingStore property value. Stores model information.
func (m *ItemOnenoteNotebooksItemSectionsItemCopyToNotebookPostRequestBody) SetBackingStore(value BackingStore)() {
