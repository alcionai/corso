...
func (m *ItemContentTypesAddCopyPostRequestBody) GetBackingStore()(BackingStore) {
...
func (m *ItemContentTypesAddCopyPostRequestBody) SetBackingStore(value BackingStore)() {
