...
The official documentation for adding an Azure AD Application and Service Principal using the Azure Portal can be found
...
2. **Configure basic settings**
   ...
   * Select **Acounts in this organizational directory only**
...
## Export Appplication Credentials
...
To obtain these select Overview from from the app management panel and export the corresponding environment variables.
...
Finally, you need to configure a cleint secret associated with the app using **Certificates & Secrets** from the app
management panel.

Click **New Client Secter** and follow the instructions to create a secret. After creating the secret, copy the secret
value immediately; it is only available right after creation. Finally, export as an environmet variable.
