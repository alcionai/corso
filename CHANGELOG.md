...
### Known Issues
- Item.Attachments panic during serialization when the item's attachment field is not nil. ([Kiota-61](https://github.com/microsoft/kiota-serialization-json-go/issues/61))
